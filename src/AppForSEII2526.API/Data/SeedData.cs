...
namespace AppForSEII2526.API.Data
{
    public static class SeedData
    {
        ...
        public static void SeedUsers(UserManager<ApplicationUser> userManager, List<string> roles)
        {
            ...
            {
                ApplicationUser user = new ApplicationUser(2, "Jaime", "López Moreno", "Tamos", "jaime@uclm.es", 656251484);
                user.EmailConfirmed = true;
            ...
            if (userManager.FindByNameAsync("peter@uclm.es").Result == null)
            {
                ...
                ApplicationUser user = new ApplicationUser(3, "Daniel", "García Rodenas", "Carretera de Madrid 28 1 c", "daniel@uclm.es", 684715236);
                user.EmailConfirmed = true;
